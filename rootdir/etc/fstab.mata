...
/dev/block/bootdevice/by-name/userdata   /data              ext4   noatime,nodiratime,nosuid,nodev,barrier=1,noauto_da_alloc   latemount,wait,check,formattable,fileencryption=ice,quota
